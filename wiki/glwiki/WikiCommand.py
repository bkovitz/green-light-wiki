...
def makeWikiCommandFromApacheEnvironment(environ, stdin=None, wikiName=None):
    ...
    return WikiCommand(
        command, wikiName, pageName, inputFile, environ.get("REMOTE_ADDR"), formDict
    )
...
class WikiCommand:
    ...
    def __eq__(self, other):
        return (
            ...
            and self.wikiName == other.wikiName
            and self.pageName == other.pageName
            and self.userName == other.userName
            and self.formDict == other.formDict
        )
