...
class ut_Environments:
    ...
    def testGetApache(self):
        ...
        environ = {
            ...
            "HTTP_COOKIE": '$Version="1"; wiki-session="%s"; $Path="/ben"; $Domain=".cds.caltech.edu", $Version="1"; other-cookie="blah blah blah"; $Path="/ben"; $Domain=".cds.caltech.edu"'
            % sessionId,
        }
        stdin = StringIO()
    ...
    def testIgnoreSpuriousComma(self):
        ...
        cookie = SimpleCookie()
        cookie.load(
            '$Version="1"; wiki-session=fKoeAgK2N14qV6z9l7s3, SITESERVER=ID=07d36133d9879185cb3782bd2b275415, second_to_last_visit=1065127677, last_visit=1066157942, ad_browser_id=23135049'
        )
