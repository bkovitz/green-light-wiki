...
textChunkClasses = {
    ...
    "UnorderedListItem": r'<table><tr><td class="bullet">&bull;<td><%= text %></td></tr></table>\n',
    "ChangedUnorderedListItem": r'<table class="changed"><tr><td class="bullet">&bull;<td><%= text %></td></tr></table>\n',
    "OrderedListItem": r'<table><tr><td class="bullet"><%= number %><td><%= text %></td></tr></table>\n',
    "ChangedOrderedListItem": r'<table class="changed"><tr><td class="bullet"><%= number %><td><%= text %></td></tr></table>\n',
}

fmtMakeClass = """class %sChunk(%sGenericChunk):
...
class LinkToExistingPageChunk(GenericChunk):
    ...
    def __init__(self, page, pageName, wikiRepository):
        ...
        GenericChunk.__init__(
            self, page, "LinkToExistingPage", """<a href="<%=url%>"><%=pageName%></a>"""
        )
