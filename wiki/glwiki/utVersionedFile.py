...
from VersionedFile import VersionedFile, VersionInfo, _parse, BadVersionException
...
"""
    ...
    def testWriteNewFile(self):
        ...
        expect = """@@ version 1; date [0-9.]+; author BenKovitz;
@@ hereis 1
First line of the file
Second line of the file
"""
...
"""
        ...
        expect = """@@ version 2; date [0-9.]+; author GeorgeGibbons;
@@ version 1; date 12.34.56.78.12.34; author BenKovitz;
@@ hereis 2
...
"""
        ...
        expect = ["No versioning in this file.\n", "\n", "Third line.\n"]
