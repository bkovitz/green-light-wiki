...
class ut_RecentChanges:
    ...
    def testRender(self):
        items = [
            MostRecentChangeToAPage(
                "OnePage", "GeorgeGibbons", _t((2003, 7, 24, 15, 50, 21))
            ),
            MostRecentChangeToAPage(
                "SecondPage", "DrJohnMittens", _t((2003, 7, 24, 12, 50, 21))
            ),
        ]

        expect = """Thursday, July 24
...
"""
    ...
    def testRenderHtml(self):
        items = [
            ...
            MostRecentChangeToAPage(
                "SecondPage", "121.12.131.14", _t((2003, 7, 24, 12, 50, 21))
            ),
        ]
        ...
        expect = HtmlHolder(
            [
                ...
                % (
                    ...
                    HtmlAnchor(
                        "http://greenlightwiki.com/GeorgeGibbons", "George Gibbons"
                    ),
                ),
