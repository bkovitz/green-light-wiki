...
from Html import HtmlDiv, HtmlForm, HtmlInputText, HtmlInputSubmit, HtmlPara, \
   HtmlAnchor, HtmlInputHidden, H1
...
class MightRequireLogin(WikiPage):
   ...
   def needLogin(self):
      ...
      return not SessionDatabase.isLoggedIn(
         self._environment.getSessionId()
      )
      ...
      return HtmlDiv(
         ...
         data=HtmlForm(
            ...
            items = [
               ...
               HtmlPara("If you'd prefer to edit anonymously, just leave the name field blank."),
