...
class ut_Diff:
   ...
   def testReplaceDecreasesLines(self):
      a1 = ['This is just a test wiki for trying out new versions of the [[Green Light Wiki http://greenlightwiki.com]] software.\n', '\n', '----\n', "'''Gibberish begins here...'''\n", '\n']
      a2 = ['This is just a test wiki for trying out new versions of the [[Green Light Wiki http://greenlightwiki.com]] software.\n', '\n', "== Gibberish begins here... ==\n", '\n']
