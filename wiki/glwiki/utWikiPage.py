...
class FakeChunkPage(WikiPage):
    ...
    def makeStyleSheets(self):
        self._styleSheets = '<link rel="stylesheet" href="wiki.css" type="text/css">'
...
class ut_WikiPage:
    ...
    def testFakeRenderHtml(self):
        ...
        TEST_EQ(
            '<link rel="stylesheet" href="wiki.css" type="text/css">', got.stylesheets
        )
