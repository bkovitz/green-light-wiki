...
class ut_DisplayPage:
    ...
    def testTop(self):
        ...
        TEST_EQ(
            '<P CLASS="logo"><A HREF="http://greenlightwiki.com/WelcomePage"><IMG SRC="http://greenlightwiki.com/b5WikiLogo.gif" BORDER=0></A></P>\n',
            str(got.logo),
        )
        TEST_EQ(
            '<A HREF="http://greenlightwiki.com/WelcomePage">Welcome Page</A>',
            str(got.homeLink),
        )
