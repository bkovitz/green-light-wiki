...
from Html import Html, HtmlBody, HtmlTable, HtmlRow, HtmlDatum, \
             HtmlForm, HtmlInputSubmit, HtmlInputHidden, Standalone, \
             Container, HtmlHead, HtmlTitle, HtmlMeta, \
             HtmlQuotedAttribute, HtmlAnchor, HtmlImage, HorizontalSpread, \
             HtmlAttribute, ButtonLink, OneRowTable, HtmlHolder, HtmlPara, \
             HardCoded, HtmlDiv
...
"""
   ...
   def testHtmlBody(self):
      htmlGenerator = HtmlBody(
         bgcolor=HtmlAttribute("BGCOLOR", "#CCCCCC"),
         contents="contents"
      )
...
"""
   ...
   def testStandaloneInsideIndentedContainer(self):
      htmlGenerator = HtmlDatum([
         HtmlAnchor("url1", HtmlImage("url2"))
      ])
