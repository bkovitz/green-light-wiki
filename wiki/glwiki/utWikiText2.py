...
"""
    ...
    def testEqualsSignInHeading(self):
        ...
        expect = [Paragraph(Heading5Chunk, "2 + 2 = 4")]
        TEST_EQ(expect, text.makeParas())
    ...
    def testForceLineBreak(self):
        ...
        expect = [Paragraph(ParagraphChunk, "First line<br>Second line")]
        TEST_EQ(expect, text.makeParas())
    ...
    def testBulletedListItem(self):
        ...
        expect = [
            Paragraph(
                UnorderedListItemChunk,
                'item <A HREF="http://greenlightwiki.com/With_Link" CLASS="new">With Link</A>',
            )
        ]
        TEST_EQ(expect, text.makeParas())
